...
that identifies the recipe the comment pertains to. To do that, we need to use some PHP code. 
-->


<?php
	$recipeid = $_GET['id'];
	//isset is used to determine whether the valid_recipe_user array variable has been set
